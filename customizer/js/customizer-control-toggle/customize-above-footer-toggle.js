...
OPNCustomizerToggles ['amaz_store_above_footer_layout'] = [
		    {
				controls: [    
				'amaz_store_above_footer_col1_set',
				'amaz_store_above_footer_col2_set',
				'amaz_store_above_footer_col3_set',
				'amaz_store_footer_col1_texthtml',
				'amaz_store_footer_col1_widget_redirect',
	            'amaz_store_footer_col1_menu_redirect',
				'amaz_store_footer_col1_social_media_redirect',
				'amaz_store_above_footer_col2_texthtml',
				'amaz_store_above_footer_col2_widget_redirect',
				'amaz_store_above_footer_col2_menu_redirect',
				'amaz_store_above_footer_col2_social_media_redirect',
				'amaz_store_above_footer_col3_texthtml',
				'amaz_store_above_footer_col3_widget_redirect',
				'amaz_store_above_footer_col3_menu_redirect',
				'amaz_store_above_footer_col3_social_media_redirect',
				'amaz_store_above_ftr_hgt',
				'amaz_store_abv_ftr_botm_brd',
				'amaz_store_above_frt_brdr_clr',
				],
			...
			},
           {
...

			{
				...
				callback: function(layout){
					var val = api( 'amaz_store_above_footer_col1_set' ).get();
			...
			// col2
			{
				...
				callback: function(layout){
					var val = api( 'amaz_store_above_footer_col2_set' ).get();
			...
			// col3
			{
				...
				callback: function(layout){
					var val = api( 'amaz_store_above_footer_col3_set' ).get();
...
OPNCustomizerToggles ['amaz_store_above_footer_col1_set'] = [
		    {
				controls: [    
				'amaz_store_footer_col1_texthtml',
				'amaz_store_footer_col1_widget_redirect',
				...
				callback: function(layout){
					var val = api( 'amaz_store_above_footer_layout' ).get();
...
OPNCustomizerToggles ['amaz_store_above_footer_col2_set'] = [
		    {
				controls: [    
				'amaz_store_above_footer_col2_texthtml',
				'amaz_store_above_footer_col2_widget_redirect',
...
OPNCustomizerToggles ['amaz_store_above_footer_col3_set'] = [
		    {
				controls: [    
				'amaz_store_above_footer_col3_texthtml',
				'amaz_store_above_footer_col3_widget_redirect',
