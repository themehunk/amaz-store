/* 
Amaz Store Responsive Menu script
----------------------------------------*/
(function ($){
  
    $.fn.amazStoreResponsiveMenu = function (options){
        ...
        function menuCollapse(){
            ...
            if (w <= $resizeWidth){
                ...
                $('.main-header .menu-toggle,.sticky-header .menu-toggle,.below-header .menu-toggle,.responsive-main-header .menu-toggle').show();
                $('.amaz-store-menu a,.menu-close-btn,.arrow').attr('tabindex',-1);
                }else{
